...
<%@page import="controlador.controladorEscala"%>
<%@page import="modelo.entidade.Escala"%>
...
<html>
    <html>
        <head>
            ...
            <script src="scripts/adm-admin-esca.js"></script>
        </head>
        <body>
            <%
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div style="margin-top: 120px;">  
                            ...
                            <div class="col-md-9">
                                <div class="col-md-12">
                                    <a href="adm-admin-esca-cad.jsp" class="btn btn-success btn-lg btn-nova-categoria">
                                        <span class="glyphicon glyphicon-plus"></span> Cadastrar
                                    </a>
                                    <h3>
                                        <%
                                            //trazendo dados com controller
                                            controladorEscala c = new controladorEscala();
                                        %>
                                        Lista de Escalas de Pesos
                                    </h3>
                                    <br/>
                                    ${msgRetorno }     
                                    <div>
                                        ...
                                        <table class="table display" id="myTable" data-order='[[ 1, "asc" ]]' data-page-length='9'>
                                            ...
                                            <td class="col-lg-2 col-md-2 col-xs-2"><b>Nome</b></td>
                                            <td class="col-lg-2 col-md-2 hidden-xs hidden-sm"><b>Preço</b></td>
                                            <td class="col-lg-2 col-md-2 hidden-xs hidden-sm"><b>Peso Min.</b></td>
                                            <td class="col-lg-2 col-md-2 hidden-xs hidden-sm"><b>Peso Max.</b></td>
                                            <td class="col-lg-1 col-md-1"><b>Excluir</b></td>
                                            </thead>
                                            <%
                                                //listagem de Escalas
                                                List<Escala> Escalas = c.getEscalas();
                                                for (Escala e : Escalas) {
                                            %>
                                            <tr>
                                                <td class="col-lg-1 col-md-1 col-xs-1"><b></b><%=e.getId()%></td>
                                                <td class="col-lg-2 col-md-2 xol-xs-2"> <a href="editEscala?id=<%=e.getId()%>" onClick="adminSuccess();"><%=e.getTipo()%></a></td>
                                                <td class="col-lg-2 col-md-2 hidden-sm hidden-xs"><%=e.getPreco()%></td>
                                                <td class="col-lg-2 col-md-2 hidden-sm hidden-xs"><%=e.getPsoMin()%></td>
                                                <td class="col-lg-2 col-md-2 hidden-sm hidden-xs"><%=e.getPesoMax()%></td>
                                                <td class="col-lg-1 col-md-1 col-xs-1">
                                                    <button onclick="del(<%=e.getId()%>)" class="btn btn-danger" name="delete" value="delete"><span class="fa fa-remove"></span> Excluir</button>
                                                </td> 
                                            </tr>
                                            <%
                                                }
