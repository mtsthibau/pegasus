                                        ...
                                        <table class="table display" id="myTable" data-order='[[ 2, "asc" ]]' data-page-length='9'>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-xs-1 text-center">   
                                                    <% if (p.getStatus().equals("Aguardando Retirada")) {%>
                                                    <a href="obterRotaRet?id=<%=p.getId()%>&idFkEntr=<%=usuario.getId()%>" class="btn btn-info fa fa-map-marker"></a>
                                                    <% } else if (p.getStatus().equals("Coleta Iniciada")) {%>                                            
                                                    <a href="obterRotaRet?id=<%=p.getId()%>&idFkEntr=<%=usuario.getId()%>" class="btn btn-primary fa fa-map-marker"></a>
                                                    <% } else {%>                                            
                                                ...
                                                <td class="col-xs-1">
                                                 ...
                                                 <td class="col-xs-1">
                                                     <button onclick="del(<%=p.getId()%>)" href="devolverEntrega?id=<%=p.getId()%>" class="btn btn-danger pull-right"><span class="fa fa-minus-circle"></span> Devolver</button>
                                                </td>
                                            </tr>
                                            <%  }%>
                                        </table>
