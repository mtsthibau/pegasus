                    ...
                    <div class="row">
                        ...
                        <div style="margin-top: 140px;">  
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="col-lg-12">
                                    ${msgRetorno } 
                                    <form action="cadPostagem">
                                        <div style="display: none">
                                            <input id="idRem" value="<%=rem.getId()%>" name="idRem"/>
                                        ...
                                        <h3>
                                            ...
                                            Cadastrar Entrega  ${id } </h3>
                                        <hr/>
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <h4>Entrega</h4>
                                            <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                                                <div class="form-group">
                                                    <label class="label-form disabled">Descrição da entrega</label>  
                                                </div>
                                            </div>
                                            <div class="col-lg-9">
                                                <div class="form-group">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                                                <div class="form-group">
                                                    <label class="label-form">Período para recebimento</label><label class="requerido"> *</label>  
                                                </div>
                                            </div>
                                            <div class="col-lg-9">
                                                <div class="form-group">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                                                <div class="form-group">
                                                    <label class="label-form">Nome do destinatário</label><label class="requerido"> *</label></label>  
                                                </div>
                                            </div>
                                            <div class="col-lg-9">
                                                <div class="form-group">
