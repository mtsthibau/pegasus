                ...
                <div class="row">
                    ...
                    <div style="margin-top: 100px;">
                        ...
                        <div class="col-md-12 content-home">
                            ...
                            <div class="col-sm-8">
                                <h1 class=" titulo-sessao">Contato</h1>
                                ${msgRetorno}
                                <div class="col-md-12">
                                    <div class="panel panel-default" ng-controller="contentLogin as c">
                                        <div class="panel-heading"><h3>Entre em contato com a Pegasus</h3></div>

                                        <form action="contato"/>
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <label>Seu E-mail<label class="requerido"></label></label>
                                                <input type="email" name="email" class="form-control" placeholder="Digite seu e-mail">
                                            </div>
                                            <div class="form-group">
                                                <label>Nome<label class="requerido">*</label></label>
                                                <input type="text" name="nome" class="form-control" placeholder="Digite seu nome">
                                            </div>
                                            <div class="form-group">
                                                <label>Assunto<label class="requerido"></label></label>
                                                <input type="text" name="assunto" class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group">
                                                <label>Mensagem <label class="requerido"></label></label>
                                                <textarea type="" name="motivo" class="form-control" placeholder="Diga o motivo de seu contato" rows="10"></textarea>
                                            </div>
