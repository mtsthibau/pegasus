                ...
                <div class="row">
                    ...
                    <div style="margin-top: 100px;">
                        ...
                        <div class="col-md-12 content-home">
                            ...
                            <div class="col-sm-8">
                                <h1 class=" titulo-sessao"> Receba suas entregas pela Pegasus</h1>
                                <h3>Entregador</h3>
                                <p  class="formatTexto">
                                    Receba suas entregas em casa com todo o conforto que a Pegasus vai te proporcionar! <br>
                                    Com o nosso sitema você pode rastrear suas entregas em tempo real. <br><br>
                                    Receba notificações em todos os passos da sua entrega minimizando o risco de não estar em casa para recebe-la.<br>
                                    Você ainda poderá nos ajudar a garantir a qualidade dos nossos serviços, avaliando o entregador em cada entrega realizada com sucesso, e ainda acompanhe a pontuação dos melhores entregadores da Pegasus, assim você poderá ter certeza que nossos serviços são realmente de qualidade.
                                </p>
                                <a href="content-ranking.jsp" class="btn btn-orange"><strong><span class="fa fa-trophy"></span> Veja o ranking!</strong><br> Acompanhe nossos melhores entregadores!</a>
                                </form>
