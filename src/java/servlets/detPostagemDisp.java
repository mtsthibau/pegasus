 ...
 * @author matheus
 */
@WebServlet(name = "detPostagemDisp", urlPatterns = {"/views/detPostagemDisp"})
public class detPostagemDisp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("rem", post.getRem());
            ...
            request.setAttribute("latitude", post.getLatitude());
            request.setAttribute("longitude", post.getLongitude());
            request.setAttribute("distancia", post.getDistancia());
            request.setAttribute("valorTotal", post.getValorTotal());

            request.getRequestDispatcher("adm-entr-disp-det.jsp").forward(request, response);
