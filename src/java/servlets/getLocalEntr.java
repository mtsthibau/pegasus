 ...
 * @author matheus
 */
@WebServlet(name = "getLocalEntr", urlPatterns = {"/views/getLocalEntr"})
public class getLocalEntr extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(getLocalEntr.class.getName()).log(Level.SEVERE, null, ex);
