 ...
 * @author matheus
 */
@WebServlet(name = "altRemetente", urlPatterns = {"/views/altRemetente"})
public class altRemetente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!"".equals(nome) && !"".equals(email) && !"".equals(cpf) && !"".equals(celular)
                    ...
                    && !"".equals(senha) && !"".equals(senhaConf) && !"".equals(latitude) && !"".equals(longitude)) {
...
//                request.setAttribute("email", email);
                ...
                request.setAttribute("latitude", latitude);
                request.setAttribute("longitude", longitude);
                request.setAttribute("msgRetorno", "<div class=\'col-md-12 alert alert-success\'>Perfíl alterado com sucesso</div>\n");
                request.getRequestDispatcher("adm-rem-perf.jsp").forward(request, response);
