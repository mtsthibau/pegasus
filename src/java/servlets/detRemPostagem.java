 ...
 * @author matheus
 */
@WebServlet(name = "detRemPostagem", urlPatterns = {"/views/detRemPostagem"})
public class detRemPostagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("adm-rem-post-det.jsp").forward(request, response);
            ...
            request.getRequestDispatcher("adm-rem-hist.jsp").forward(request, response);
        }
    }
