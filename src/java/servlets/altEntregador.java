 ...
 * @author matheus
 */
@WebServlet(name = "altEntregador", urlPatterns = {"/views/altEntregador"})
public class altEntregador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!"".equals(nome) && !"".equals(email) && !"".equals(senha) && !"".equals(cnpj)
                ...
                EntrDAO.editEntr(E, idInt);

                //mensagem
                request.setAttribute("msgRetorno", "<div class=\'col-md-12 alert alert-success\'>Entregador alterado com sucesso</div>\n");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(cadEntregador.class.getName()).log(Level.SEVERE, null, ex);
