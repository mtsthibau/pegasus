 ...
 * @author matheus
 */
@WebServlet(name = "detPostagem", urlPatterns = {"/views/detPostagem"})
public class detPostagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("adm-admin-post-det.jsp").forward(request, response);
