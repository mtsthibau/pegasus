 ...
 * @author matheus
 */
@WebServlet(name = "cadPostagem", urlPatterns = {"/views/cadPostagem"})
public class cadPostagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException, ParseException, ModeloException, SQLException {
        ...
        try {
            ...
            if (!"".equals(peso) && !"".equals(altura) && !"".equals(profundidade) && !"".equals(largura)
                ...
                if (esc == null) {
                    ...
                    request.getRequestDispatcher("adm-rem-post-cad.jsp").forward(request, response);
                    return;
                }
                ...
                PostsDAO.insertPost(P);
                //mensagem
                request.setAttribute("msgRetorno", "<div class=\'col-md-12 alert alert-success\'>Postagem cadastrada com sucesso</div>\n");
