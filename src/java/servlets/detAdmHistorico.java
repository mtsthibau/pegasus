 ...
 * @author matheus
 */
@WebServlet(name = "detAdmHistorico", urlPatterns = {"/views/detAdmHistorico"})
public class detAdmHistorico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("adm-admin-hist-det.jsp").forward(request, response);
            ...
            request.getRequestDispatcher("adm-admin-hist.jsp").forward(request, response);
        }
    }
