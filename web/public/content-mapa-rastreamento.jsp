...
<html>
    ...
    <body>
        ...
        <div class="col-xs-12" style="margin-top: 80px;">
            <!--            <div class="col-xs-4" style="padding-left: 85px"><h3>Digite o código da sua entrega:</h3></div>
                        <div class="col-xs-4">
                            <h3><input type="text" class="form-control" id="entregaId" name="entregaId" value="${entregaId }" placeholder=""/></h3>
                        </div>-->

            <div class="col-xs-12">
                <h1 class=" titulo-sessao"><span class="fa fa-map-marker"></span> Rastrear Entrega</h1>
                <div class="col-xs-9">
                    ${msgRetorno}
                </div>
                <div class="col-xs-3">
                    <button onclick="initMap(${latitude}, ${longitude})" class="btn btn-orange btn-lg center-block">
                        <span class="fa fa-map-marker"></span> Rastrear Entrega
                    </button>
                </div>                
            </div>

            <div class="col-xs-12" style="margin-top:10px">
                <div class="well" id="map" style="height: 400px">
                </div>
            </div>
        </div>
